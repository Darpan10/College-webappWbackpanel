...
<div class="container">
  <nav class="navbar navbar-expand-lg"style="background-color:#2e353d;color:white ;">
    <a class="navbar-brand">undergrad</a>
  </nav>
</div>
...
<div class="form-group">
    <label for="t2">intro:</label>
    <textarea class="form-control" id="t2" rows="12" name="text2"></textarea>
  </div>
...
<button type="submit" class="btn btn-primary" value="NEWS" name="NEWS">NEXT</button>
